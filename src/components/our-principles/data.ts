export const OUR_PRINCIPLES = {
  en: [
    {
      title: 'Focus',
      description: 'Global Construction attracts attention with all internal and external electrical work carried out by it, design features, and technological advantages of equipment for weighing, control, and automation of O.G. facilities. and A.G., in addition, adds value to the rooms it affects. Global Construction, in terms of the functionality of each project it focuses on, has the goal of delivering important benefits to the user in turnkey projects.'
    },
    {
      title: 'Differentiation',
      description: 'Differentiation competence is the main determinant of Global Construction competitiveness. Using the competence of differentiation, both on a national scale and in the geography of the environment, our company aimed at making new breakthroughs, producing original projects.'
    },
    {
      title: 'Innovation',
  ...
  ua: [
    {
      title: 'Зосередженість (Фокусування)',
      description: 'Global Construction привертає увагу усіма внутрішніми і зовнішніми електромонтажними роботами здійсненими нею, проектними особливостями і технологічними перевагами обладнання для зважування, контролю і автоматизації об\'єктами O.G. і A.G., крім цього додає цінності приміщень на які впливає. Global Construction, з точки зору функціональності кожного проекту, на якому зосереджується, має на меті в «проектах під ключ» забезпечувати користувачеві важливі вигоди.'
    },
    {
      title: 'Диференціація',
      description: 'Компетенція диференціації, є основним визначником конкурентоспроможності Global Construction. Наша компанія використовуючи компетенцію диференціації, як в національних масштабах, так і в географії оточення націлилася на здійснення нових проривів, виробництво оригінальних проектів.'
    },
    {
      title: 'Новаторство',
